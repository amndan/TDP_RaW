...
\begin{description}
	...
	\item [youbot-driver] Our youBot platform is controlled with this package. So we are able to send movement commands from PC1 to PC2 over ROS. On PC2, which is connected to the motor drivers and the actuator via EtherCAT protocol, youbot-drivers are running.
	\todo{dominik: add software for vision please}
\end{description}
